...
Сценарий: экспорт настроек картинок
	...
	И я перезаполняю для объекта табличную часть "ConnectionSetting":
		| 'Ref'                                                                         | 'Key'         | 'Value'                                                                     |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49494' | 'AddressPath' | 'E:\\Courses\\1С\\Платформа 1С 8\\QAB1101-All-Materials\\Pictrure\\Source'  |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49495' | 'AddressPath' | 'E:\\Courses\\1С\\Платформа 1С 8\\QAB1101-All-Materials\\Pictrure\\Preview' |
